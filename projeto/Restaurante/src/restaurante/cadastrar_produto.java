...
public class cadastrar_produto extends JDialog implements ActionListener{
    
    JTextField inserir[] = new JTextField[5];
    JFormattedTextField data_validade;
    JButton salvar;
    ...
    JScrollPane b;
     ...
     public cadastrar_produto(){
                ...
                dados[1] = new JLabel("Data validade: \n");
                dados[2] = new JLabel("Valor: \n");
                dados[3] = new JLabel("Quantidade: \n");
                dados[4] = new JLabel("Codigo de barra: \n");
                
                data_validade = new javax.swing.JFormattedTextField();
                
                try {
                    data_validade.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##/##/####")));
    ...
    public void salvar(){
            ...
            a[1] = data_validade.getText();
            a[2] = inserir[2].getText();
            a[3] = inserir[3].getText();
            a[4] = inserir[4].getText();

            String b = "insert into produto(nome, data_validade, valor, quantidade, cod_barra)"
                    + "values (\""+a[0]+"\", \""+a[1]+"\", "+Double.parseDouble(a[2])+", "
                    + ""+Integer.parseInt(a[3])+", "+Integer.parseInt(a[4])+")";

            Conexao c = new Conexao();
            c.inserir_banco(b);
            
            JOptionPane.showMessageDialog(this,new JLabel("PRODUTO CADASTRADO"));
   } 
