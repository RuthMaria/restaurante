...
public class rodizio extends JDialog implements ActionListener{
    ...
    public rodizio(){
                ...
                dados[4] = new JLabel("Quantidade de pessoas: \n");
    ...
    public void salvar(){
            ...
            String b = "insert into rodizio(id_garcom, cpf_cliente, valor_total, comissao_func, quant_pessoas) "
