...
public class self_service extends JDialog implements ActionListener{
    ...
    public self_service(){
                ...
                dados[4] = new JLabel("Quantidade da porção(g): \n");
    ...
    public void salvar(){
            ...
            String b = "insert into self_service(id_garcom, cpf_cliente, valor_total, comissao_func, quant_porcao) "
                    + "values ("+Integer.parseInt(a[0])+", \""+a[1]+"\", "+Double.parseDouble(a[2])+","
