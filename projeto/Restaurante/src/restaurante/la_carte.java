...
public class la_carte extends JDialog implements ActionListener{
    ...
    public la_carte(){
                ...
                dados[4] = new JLabel("Quantidade de pratos: \n");
    ...
    public void salvar(){
            ...
            String b = "insert into la_carte(id_garcom, cpf_cliente, valor_total, comissao_func, quant_pratos) "
